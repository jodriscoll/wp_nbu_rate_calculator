...
<?php
 /**
 * Returns an acf field as a data attribute
 *
 * @param $field_selector (string) $field_selector The acr field selector.
 *
 * @return string|string[]
 */
function get_field_as_element( $field_selector ) {
	$string_to_return = '';
	$field_value      = get_field( $field_selector );
	if ( $field_value ) {
		$string_to_return = '<div class="' . $field_selector . '">' . $field_value . '</div>';
	}
